try:
   ...
   from datetime import datetime
    ...
    input("[gamesense] Please install the modules before running!")


ascii_text = """       
 ___ ___ _____ ___ ___ ___ ___ ___ ___  
| . | .'|     | -_|_ -| -_|   |_ -| -_| 
|_  |__,|_|_|_|___|___|___|_|_|___|___| 
|_  |__,|_|_|_|___|___|___|_|_|___|___| 
|___|                                 
  """
class snapchat:
    ...
    def get_positions(self):
        self.print_console("[gamesense] Move your mouse to the camera button, then press F")
        while True:
            if keyboard.is_pressed("F"):
                self.switch_to_camera = pyautogui.position()
                break
        time.sleep(0.5)
        self.print_console("[gamesense] Move your mouse to the take picture button, then press F")
        while True:
            if keyboard.is_pressed("F"):
                self.take_picture = pyautogui.position()
                break
        time.sleep(0.5)
        self.print_console("[gamesense] Move your mouse to the arrow down button, then press F")
        while True:
            if keyboard.is_pressed("F"):
                self.arrow_down = pyautogui.position()
                break
        time.sleep(0.5)
        self.print_console("[gamesense] Move your mouse to the Multi Snap button, then press F")
        while True:
            if keyboard.is_pressed("F"):
                self.multi_snap = pyautogui.position()
                break
        time.sleep(0.5)
        self.print_console("[gamesense] Move your mouse to the Edit & Send button, then press F")
        while True:
            if keyboard.is_pressed("F"):
                self.edit_send = pyautogui.position()
                break
        time.sleep(0.5)
        self.print_console("[gamesense] Move your mouse to the Send To button, then press F")
        while True:
            if keyboard.is_pressed("F"):
                self.send_to = pyautogui.position()
                break
        time.sleep(0.5)
        self.print_console("[gamesense] Move your mouse to your shortcut, then press F")
        while True:
            if keyboard.is_pressed("F"):
                self.shortcut = pyautogui.position()
                break
        time.sleep(0.5)
        self.print_console("[gamesense] Move your mouse to select all in shortcut, then press F")
        while True:
            if keyboard.is_pressed("F"):
                self.select_all = pyautogui.position()
                break
        time.sleep(0.5)
        self.print_console("[gamesense] Move your mouse to send snap button, then press F")
        while True:
            if keyboard.is_pressed("F"):
    ...
    def main(self):
        ...
        if options == 1:
            self.delay = 2
        self.print_console("[gamesense] Go to your chats, then press F when you're ready.")
        ...
        os.system("cls")
        print(Fore.RED + ascii_text)
        self.print_console("[gamesense] Sending snaps...")
        ...
        while True:
            ...
            time.sleep(4)
        self.print_console(f"[gamesense] Finished sending {self.sent_snaps} snaps.")
